...
if X.ndim == 3:
	...
	rgb = False;
#print A.shape;
m = 150;	#No of rows in the image (no of images)
n = 1;	#No of cols in the image (no of features)
#A new matrix with m*n rows is created. One image corresponds to one column. In fact we do sliding img2col, so if we want we can split the image into small blacks.
